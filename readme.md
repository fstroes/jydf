...
The estimate consistently estimates the self influence and the resulting degrees of freedom estimate $\hat{\text{df}} \pi$ can therefore be plugged into metrics like Akaike's information criterion (AIC) as the model degrees of freedom.
