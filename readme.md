...
- **QMC Integration:** Utilizes Quasi-Monte Carlo (Sobol sequences via `scipy.stats.qmc`) to ensure perturbations are perfectly mean-zero and space-filling.
- **Parallel Execution:** Built to run across multiple CPU cores using `ThreadPoolExecutor`.
